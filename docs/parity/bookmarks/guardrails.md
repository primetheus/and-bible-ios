...
1. focused UI coverage for generic-bookmark visible workflows
2. focused UI coverage for broader StudyPad reorder/delete behavior
3. machine-readable snapshots of bookmark sort/filter state contracts if the UI
   surface grows materially more complex
